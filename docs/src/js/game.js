...
export default class Game extends Phaser.Scene {
  ...
  preload() {  //Aqui se precargan las imagenes para el juego, para que vaya mas rapido.
    ...
    /*AUDIO*/
    this.load.audio("prueba", "./assets/musica/myst-on-the-moor-by-kevin-macleod-from-filmmusic-io_bucle_misterioso_DEMOMENTOLAMEJOR.mp3");
    /*Protagonista_comiendo*/
    this.load.audio("prueba_comer","./assets/musica/sonidos_concretos/Eating-SoundBible.com-1470347575.mp3");
    /*Enemigo_zombie*/
    this.load.audio("prueba_zombie","./assets/musica/sonidos_concretos/Zombie Brain Eater-SoundBible.com-1076387080.mp3");
  }
  ...
  create() { //Este se ejecuta justo despues del preload.
   ...
   addGround(scene, map){ //Necesitamos un tileset para esto 
   ...
   addCamera(scene, player, ground) {
     scene.cameras.main.setBounds(0,0,ground.widht,ground.height); //Para que no se salga del mapa
   ...
   audio_comiendo(){
    ...
    /*SPAWNS*/
      ...
      spawnPlayer(scene,x,y,ground){
        ...
        albon.createAnims(); //Animaciones en clase aparte prota.js
        return albon;
      }
      ...
      spawnEnemigo_Runner(scene,x,y,enemies){
        ...
        enemigo_runn.createAnims(); ////Animaciones en clase aparte enemigo_runner.js
